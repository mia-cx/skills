...
* **If using a hero**, keep its main interaction reachable and its headline short. Subtext is optional and must pass ui-design's necessary-prose rule. Show the product's value through a visual example.
...
* **Opening composition:** build around what visitors can see or do. Add only the heading, controls, and necessary text that experience needs. There is no required text stack.
...
* **Eyebrows:** apply ui-design §10. Remove every decorative preheading, including sentence-case kickers and numbered overlines.
...
**Hero & top-of-page**
* **Product status:** show a version or beta status only where it changes a user's decision. Never place it as an eyebrow.
* **NO "Brand · No. 01"-style sub-eyebrows.** "Marrow · No. 01 · The 6-quart" type micro-meta lines. Skip them.

**Section numbering & micro-labels**
* **NO section-number eyebrows.** Remove labels such as `00 / INDEX` or `001 · Capabilities`; start with the content itself.
...
* **NO micro-meta-sentences.** Delete commentary about the page itself. Show the feature through an example.
...
- [ ] **Opening**: product understandable through a visual example, main interaction reachable, prose only where necessary?
- [ ] **Hero top padding**: max `pt-24` at desktop, hero content does not float halfway down the viewport?
- [ ] **Opening composition**: no mandatory hero text stack or decorative taglines?
- [ ] **Eyebrow count**: zero decorative preheadings, including kickers, overlines, and section numbers in any case or style?
